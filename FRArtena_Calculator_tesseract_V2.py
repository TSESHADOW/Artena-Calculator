...
def calculo (substats):
	...
	if Refor == "Refo" and Puede=="85":
		cuadro.insert(tk.INSERT, "\n"+"Reforge estimaté à "+str(int(Score)+11)+"-"+str(int(Score)+14))
	else:
		cuadro.insert(tk.INSERT, "\n"+"------------------------------------------------------------------------")
	cuadro.insert(tk.INSERT, "\n")
	if TankH == 4 or Dps == 4 or Bruiser == 4:
		if TankH == 4:
			cuadro.insert(tk.INSERT,"\n"+"Substats pour un Tank/Healer")
		if Dps == 4:
			cuadro.insert(tk.INSERT,"\n"+"Substats pour un Dps")
		if Bruiser == 4:
			cuadro.insert(tk.INSERT,"\n"+"Substats pour un Bruiser")
	...
	cuadro.insert(tk.INSERT, "\n")
	cuadro.insert(tk.INSERT, "\n"+"------------------------------------------------------------------------")
	cuadro.insert(tk.INSERT, "\n"+"Score Arme/Casque/Armure correct :")
	cuadro.insert(tk.INSERT, "\n"+"Tank/Healer => 62")
	cuadro.insert(tk.INSERT, "\n"+"Dps => 63")
	cuadro.insert(tk.INSERT, "\n"+"Bruiser => 69")
	cuadro.insert(tk.INSERT, "\n")
	cuadro.insert(tk.INSERT, "\n"+"Score Collier/Anneau/Bottes correct :")
	cuadro.insert(tk.INSERT, "\n"+"Tank/Healer => 60")
	cuadro.insert(tk.INSERT, "\n"+"Dps => 61")
	cuadro.insert(tk.INSERT, "\n"+"Bruiser => 67")
	cuadro.insert(tk.INSERT, "\n")
	cuadro.insert(tk.INSERT, "\n"+"Tableau de Gear Score minimum par")
